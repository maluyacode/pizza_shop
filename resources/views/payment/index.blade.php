...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form  id="importForm" action="{{ route('payment.import') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <form id="paymentForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="description" placeholder="Enter Detail"
                                name="description">
                        </div>
                        <div class="form-group">
                            <label id="detail"for="detail">Image</label>
